...
<head>
    ...
    <title>Driver Details | Ambulance Service</title>
...
<div class="">
    ...
    <div class="pageheader">
        ...
        <ul class="hornav">
            <li class="current"><a href="#updates">Driver Details</a></li>
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div id="updates" class="subcontent">
            ...
            <div class="">
                ...
                <table style="..." cellpadding="0" cellspacing="0" border="0" class="stdtable overviewtable">
                    ...
                    <thead>
                    <tr>
                        <th class="head0"><h4>Driver Id</h4></th>
                        <th class="head1"><h4>Driver Name</h4></th>
                        <th class="head0"><h4>Licence No.</h4></th>
                        <th class="head1"><h4>Gender</h4></th>
                        <th class="head0"><h4>D.O.B</h4></th>
                        <th class="head1"><h4>Age</h4></th>
                        <th class="head1"><h4>Address</h4></th>
                        <th class="head1"><h4>Phone No.</h4></th>
                        <th class="head1"><h4>Experiance</h4></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
        ...
        <div id="adddriver" class="subcontent" style="display: none;">
            ...
            <form class="stdform " action="#" method="post">
                ...
                <p>
                    ...
                    <small class="desc">Enter the Driver Name.</small>
                </p>
                <p>
                    <label>Licence No</label>
                    <span class="field"><input type="text" name="input1" class="smallinput" /></span>
                    <small class="desc">Enter the Licence No.</small>
                </p>
                <p>
                    <label>Gender</label>
                    <span class="formwrapper">
                            	<input type="radio" name="radiofield" /> Female &nbsp; &nbsp;
                            	<input type="radio" name="radiofield" checked="checked" /> Male &nbsp; &nbsp;
                    <!--<small class="desc">Select the Gender.</small>-->

                <p>
                    <label>D.O.B</label>
                    <span class="field">&nbsp;<input type="text" id="datepickfrom" /> &nbsp; &nbsp;</span>
                    <small class="desc">Enter the Date of Birth.</small>
                </p>

                <p>
                    <label>Age</label>
                    <span class="field"><input type="text" name="input1" class="smallinput" /></span>
                    <small class="desc">Enter the Age.</small>
                </p>

                <p>
                    <label>Address</label>
                    <span class="field"><textarea cols="80" rows="5" class="longinput"></textarea></span>
                    <small class="desc">Enter the Address.</small>
                </p>

                <p>
                    <label>Phone No</label>
                    <span class="field"><input type="text" name="input1" class="smallinput" /></span>
                    <small class="desc">Enter the Phone No.</small>
                </p>

                <p>
                    <label>Experiance</label>
                    <span class="field"><input type="text" name="input1" class="smallinput" /></span>
                    <small class="desc">Enter the Experiance.</small>
                </p>
                <br clear="all" /><br />

                <p class="stdformbutton">
                    <button class="submit radius2">Add Driver</button>
        ...
        <div id="deletedriver" class="subcontent" style="display: none;">
